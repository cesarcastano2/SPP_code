...
%% step width detrended 
[P_width,fh_width] = fitsinglemodelprocess_sw(sw.(conds{c}).(subjs{s})(NOG:end),ws.(conds{c}).(subjs{s})(NOG:end));
p_width.(conds{c})(s,:) = P_width;
 
variation_steps_w.(conds{c}).slminusfit(s,:) = var(sw.(conds{c}).(subjs{s})(NOG:end) - fh_width(ws.(conds{c}).(subjs{s})(NOG:end),P_width));
variation_steps_w.(conds{c}).speedtrend(s,:) = var(fh_width(ws.(conds{c}).(subjs{s})(NOG:end),P_width));
variation_steps_w.(conds{c}).totalvar(s,:) = var(sw.(conds{c}).(subjs{s})(NOG:end));
%% plots
...
save detrended_w_o detrended_w_o
